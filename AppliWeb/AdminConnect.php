...
<body>
    <?php 
        ...
        if (isset($_SESSION['inscrit']) && $_SESSION==true) {
            echo '<script>alert("Inscription réussie, connectez-vous avec votre login ainsi que votre mot de passe!")</script>';
    ...
    <!--about-->
    <div class="container"> 
        <h2 class="heading-title text-center">Connexion Administrateur</h2>

        <form id="formulaire" class="form-inline" method="post" action="loginadmin.php">
                        ...
                        <button id="btn" type="submit" class="btn btn-primary btn-lg">Connexion</button>
        </form>
    </div>
